...
- 🔍 **속도 비례 동적 줌** — 고속일수록 카메라가 넓게 보여 시야 확보
- 👻 **HUD 근접 페이드** — 차량이 위젯 뒤로 지나가면 해당 위젯이 자동으로 투명해짐
- 🌿 **잔디 텍스처 + 50m 텔레메트리 그리드** — 속도감/위치감 강화
- 🏳️ **오프트랙 페널티** — 잔디 진입 시 그립 -25% / 구름저항 4배 / 엔진 -15% (트랙 리미트가 의미를 가짐)
